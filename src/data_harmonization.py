...
4. Cleans the data by converting non-numeric entries and logging the changes.
...
# Perform data cleaning by converting non-numeric entries and logging changes
...
df.rename(columns={'SUBJECTID       (unique identifier)': 'SUBJECTID'}, inplace=True)
